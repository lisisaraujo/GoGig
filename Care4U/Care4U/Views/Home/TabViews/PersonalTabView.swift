        ...
        NavigationView {
            ZStack {
                ...
                NavigationLink(
                    ...
                    isActive: $shouldNavigateToEditProfile
                ) {
                    EmptyView()
                }
                
                SideMenu(isShowing: $showMenu, content: MenuView(isPresented: $showMenu, shouldNavigateToEditProfile: $shouldNavigateToEditProfile))
            }
        }
    }
}
...
#Preview {
    PersonalTabView(selectedTab: .constant(.personal), showMenu: .constant(true))
        .environmentObject(AuthViewModel())
